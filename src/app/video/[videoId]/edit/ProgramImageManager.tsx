...
// Every image here is a plain 16:9 promotional still, so the role is not the editor's to pick.
  ...
  return (
    <section className="space-y-5 border-t border-default-200 pt-6">
      <div className="prose dark:prose-invert">
        <h2>Bilder</h2>
        <p>
          Last opp et promobilde i 16:9 — JPEG, PNG eller WebP, opptil 10 MB. Bildet blir
          kontrollert av ingest og publisert i mediearkivet sammen med videoen.
        </p>
      </div>
