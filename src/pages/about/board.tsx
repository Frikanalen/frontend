  ...
  <div>
    ...
    <div className={"flex gap-4"}>
      ...
      <div className={""}>
        ...
        <p>Egil Skarning Langemyr (Evangeliekirken Arendal), styremedlem</p>
        <p>Olav Hardang (Bladet Evangelisten), styremedlem</p>
        <p>Estehan Zouain (NUUG), styremedlem</p>
        <p>Rune Hagerup, styremedlem</p>
      </div>
    </div>
  </div>
)
